...
class _PostWidgetState extends State<PostWidget> {
  ...
  Future<void> _loadComments() async {
    ...
    final res = await http.get(
      Uri.parse('https://adivinheganhe.com.br/api/posts/comments/$postId'),
  ...
  Future<void> _comment(String content) async {
    final postId = widget.post['id'];
    await http.post(
      Uri.parse('https://adivinheganhe.com.br/api/posts/comment/$postId'),
      headers: {
  ...
  Future<void> _toggleLike() async {
    ...
    final res = await http.post(
      Uri.parse('https://adivinheganhe.com.br/api/posts/$postId/toggle-like'),
      headers: {'Authorization': 'Bearer ${widget.currentUser['token']}'},
    );
    if (res.statusCode == 200) {
      setState(() {
  ...
  Future<void> _deletePost() async {
    ...
    final res = await http.delete(
      Uri.parse('https://adivinheganhe.com.br/api/posts/delete/$postId'),
      headers: {'Authorization': 'Bearer ${widget.currentUser['token']}'},
    );
    if (res.statusCode == 200) {
