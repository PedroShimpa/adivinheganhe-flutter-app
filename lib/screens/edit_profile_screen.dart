...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<void> _saveProfile() async {
    ...
    final uri = Uri.parse('$baseUrl/usuario/update');
                  ...
                  child: Column(
                    children: [
                        ...
                        child: CircleAvatar(
                          ...
                          backgroundImage:
                              _imageFile != null
                                  ...
                                  : NetworkImage(
                                    "https://ui-avatars.com/api/?name=${Uri.encodeComponent(widget.currentUser['name'] ?? 'User')}&background=random",
                                  ),
                        ),
                      ),
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        onChanged:
                            (v) => setState(() => perfilPrivado = v ?? 'N'),
                        decoration: const InputDecoration(
                          labelText: 'Perfil Privado',
                        ),
                      ),
                      const SizedBox(height: 8),
